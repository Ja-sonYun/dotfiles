...
const BOX_ORIGINAL_RENDER = Symbol.for("jay.pi.section-bars.box-original-render");
const TEXT_ORIGINAL_RENDER = Symbol.for("jay.pi.section-bars.text-original-render");
...
function formatBarLine(bar: string, content: string | undefined, width: number): string {
