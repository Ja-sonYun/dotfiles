...
- 🔦 Use slim indicators to show stacked windows
...
This is an optional step. It's required to send configuration commands to `stackline` from scripts.
...
The stacked windows are shown as slim indicators inside the right edge of the window.
